...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Analytics-framework/Analytics.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Bolts-framework/Bolts.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Branch-framework/Branch.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Smartling.i18n-framework/Smartling_i18n.framework"
